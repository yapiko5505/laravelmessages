        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mx-4 sm:p-8">
                <form method="post" action="{{route('message.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="w-full flex flex-col">
                        <label for="content" class="font-semibold leading-none mt-4">本文</label>
                        <textarea name="content" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="content" cols="30" rows="10"></textarea>
                    </div>
    
                    <div class="w-full flex flex-col">
                        <label for="file" class="font-semibold leading-none mt-4">ファイル </label>
                        <div>
